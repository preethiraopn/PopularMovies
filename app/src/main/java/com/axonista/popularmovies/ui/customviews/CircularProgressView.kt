package com.axonista.popularmovies.ui.customviews
...
class CircularProgressView : View {
    ...
    private var enableRainbowProgress = false;
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        if (attrs != null) {
            ...
            enableRainbowProgress = typedArray.getBoolean(R.styleable.CircularProgressView_enableRainBow,false)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (totalValue != 0 && progressValue != 0 && progressValue <= totalValue) {
            if(enableRainbowProgress){
                paintProgress.shader = LinearGradient(0f, 0f, measuredWidth.toFloat(),0f,
                    colors,
                    null,
